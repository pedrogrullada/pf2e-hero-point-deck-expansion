...
const symlinkPath = path.resolve(dataPath, "modules", "pf2e-hero-point-deck-expansion");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "pf2e-hero-point-deck-expansion" ${atPath} already exists in the "modules" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
